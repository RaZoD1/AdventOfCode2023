...
class Day11lvl2() : Level("/day11/input.txt") {

    var result = 0L;

    fun colDistance(map: Array<Array<Char>>, colIdx: Int) =
        if (map.none { it[colIdx] == '#' }) 1_000_000 else 1


    fun rowDistance(map: Array<Array<Char>>, rowIdx: Int) =
        if (!map[rowIdx].contains('#')) 1_000_000 else 1
    ...
    fun countDistances(map: Array<Array<Char>>): Long {
